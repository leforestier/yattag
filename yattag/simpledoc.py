...
class SimpleDoc(object):
    ...
    def text(self, *strgs, cdata=False):
        """
        appends 0 or more strings to the document
        with cdata argument the strings wrapped in <![CDATA[]]>
        without cdata argument the strings are escaped for use as text in html documents, that is,
        & becomes &amp;
        < becomes &lt;
        > becomes &gt;
